...
class PageSize extends Widget
{
     ...
     */
    public $sizes = [1 => 1, 5 => 5, 10 => 10, 15 => 15, 20 => 20, 25 => 25, 50 => 50, 100 => 100];
    ...
    public function run()
    {
        ...
        $this->view->registerJs('$(document).on("change", "#' . $this->options['id'] . '", function(){
        var url = window.location.protocol + \'//\' + window.location.hostname + window.location.pathname;
        var params = {};
        params["' . $this->pageSizeParam . '"] = $("#' . $this->options['id'] . ' option:selected").val();
